export type damageAmount = [number, number][]; //the first number is the damage, the second number is the amount of times it get atk

export type attackingType = { [type: string]: damageAmount };

export type WeaponType = {
  [weaponType: string]: string;
};

export type WeaponDataTable = {
...
export type ConstructionDataTable = {
  [constructionType: string]: ConstructionData;
};

export const ConstructionTypeTable: ConstructionDataTable = {
  dagger: {
...
export const WeaponTypeTable: WeaponDataTable = {
  small_handle: {
    small_blade: "dagger",
