...
export const Rings: import("../models/Item").ItemDataTable = {
  ...
  earthen_ring: {
    ...
    category: "Ring",
    description:
      "A tough and sturdy ring that channels the power of the earth.",
    stats: {
      EarthBoost: 10,
    },
    perks: {
  ...
  void_contract_ring: {
    ...
    category: "Ring",
    description:
      "Painful thorns bind this ring to the assassin until the contract is complete. Commonly used by void cultists outsourcing ''work''",
    stats: {
      AttackSpeed: 2,
      PhysicalDefense: 2,
    },
  ...
  stone_giant_ring: {
    ...
    category: "Ring",
    description:
      "A crackled and dishevelled ring carved out of stone that was once living.",
    stats: {
      PhysicalBoost: 5,
      SpeedBoost: -5,
    },
